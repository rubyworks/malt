...
We can convert rdoc documents to html easily via +Malt.render+ method.

  html = Malt.render(:file=>'test.rdoc')

  html.assert.include?('Example</h1>')

(Note, that we left out the fist portion of the h1 tag becuase newer versions
of RDoc include `class="label-Example"`, while older versions do not.)
